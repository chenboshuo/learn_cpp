 ...
 * @return count
 */
unsigned int Employee::get_count() { return count; }

Employee::Employee(const string &first, const string &last)
    : first_name(first), last_name(last) {
  ++count;  // increment static count of employees
  cout << "Employee object constructor: " << first_name << ' ' << last_name
       << endl;
};

Employee::~Employee() {
  cout << "Employ object destructor: " << last_name << ", " << first_name
       << endl;
  --count;
}

string Employee::get_first_name() const { return first_name; }

string Employee::get_last_name() const { return last_name; }
