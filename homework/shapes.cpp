 ...
 public:
  ...
  void show_data() {
    cout << "The coordinate of the center of the ellipse is: "
      << "(" << center_x << ", " << center_y << ")"
      << "\nThe semimajor axis length of the ellipse: "<< a << ", " << b<< endl;
    cout << "The area is: " << area() << endl;
  }
...
class Ball : public ThreeShape{
 public:
  ...
  double area(){
    return 4* PI * redius *redius;
  }

  double volume(){
    return 4.0/3.0 * PI * pow(redius,3);
  }
 private:
  double redius;
};
...
class Cylinder : public ThreeShape{
 public:
  Cylinder (double center_x, double center_y, double center_z,
		        double redius, double height)
    : ThreeShape(center_x, center_y,center_z), redius(redius), height(height){};
...
class RectangularParallelepiped : public ThreeShape{
 public:
  ...
  void show_data() {
    cout << "The coordinate of the center of the Ball is: "
      << "(" << center_x << ", " << center_y << ", " << center_z << ")"
      << "The edge length of a cuboid is: "
			<< a << ", " << b << ", " << c << ", ";
...
int main(int argc, char const *argv[]) {
  ...
  f.show_data();
	/* output
		...
		The coordinate of the center of the Ball is: (1, 1, 0)The edge length of a cuboid is: 5, 6, 7,
		The area is: 214
		The volume is: 210
	 */
