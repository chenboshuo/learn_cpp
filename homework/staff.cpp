...
public:
    ...
    Staff  (const string &num, const string &name,
            int rate_of_attend,
            int basic_salary,
            int prize)
            :num(num), name(name), rate_of_attend(rate_of_attend),
             basic_salary(basic_salary), prize(prize){}
...
public:
    ...
    SalesMan(const string &num, const string &name, int rate_of_attend,
             ...
             int deduct_rate, int person_amount)
    ...
    int calculate_wages() {
      ...
      return static_cast<int>(basic_salary
...
public:
    Manager (const string &num, const string &name,
             int rate_of_attend,
             int basic_salary,
             int prize,
             int total_deduct_rate,
             int total_amount)
            : Staff(num, name, rate_of_attend, basic_salary, prize),
...
class SalesManager : public SalesMan, public Manager{
    public:
        SalesManager (const string &num, const string &name, int rate_of_attend,
                      ...
                      int total_amount)
                : Staff(num, name, rate_of_attend, basic_salary, prize),
                  SalesMan (num, name, rate_of_attend,basic_salary, prize,
                            deduct_rate, person_amount),
