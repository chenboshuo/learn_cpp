...
int main(int argc, char const *argv[]) {
  ...
  std::cout << "the right trianngle with legs of 3,4 is: "<< right_triangle_1.get_hypotenuse() << '\n';
  std::cout << "the right trianngle with legs of 5,12 is: "<< right_triangle_2.get_hypotenuse() << '\n';
  std::cout << "the right trianngle with legs of 8,15 is: "<< right_triangle_3.get_hypotenuse() << '\n';
